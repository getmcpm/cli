...
> Keep it updated as decisions are made. Last updated: 2026-08-17.
...
- **Local storage**: JSON files in `~/.mcpm/` (servers.json, aliases.json) — no registry cache; every registry read is a live fetch
