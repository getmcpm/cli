...
> Keep it updated as decisions are made. Last updated: 2026-07-03.
...
across all major clients (Claude Desktop, Claude Code, Cursor, VS Code, Windsurf) from a single tool.

**npm package**: `@getmcpm/cli` (v0.17.0 released; `guard --confine` shipped in v0.16.0; the Claude Code client adapter is on `main`, ships next minor) | **bin command**: `mcpm` | **repo**: github.com/getmcpm/cli | **web UI**: deferred to V1+
...
- Works across Claude Desktop, Claude Code, Cursor, VS Code, Windsurf
