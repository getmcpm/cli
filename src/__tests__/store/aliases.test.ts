...
// withStoreLock runs the real proper-lockfile + ~/.mcpm lock file; in these
// in-memory tests it should just invoke the callback. Real lock/symlink
// behavior is covered by atomic.test.ts.
